...
# Create the screen with fixed dimensions
...
def draw_exit():
    pygame.draw.rect(screen, RED, ((cols - 3) * CELL_SIZE, (rows - 2) * CELL_SIZE, CELL_SIZE, CELL_SIZE))
    # pygame.draw.rect(screen, YELLOW, ((cols - 3) * CELL_SIZE, (rows - 3) * CELL_SIZE, CELL_SIZE, CELL_SIZE))
    # pygame.draw.rect(screen, YELLOW, ((cols - 4) * CELL_SIZE, (rows - 2) * CELL_SIZE, CELL_SIZE, CELL_SIZE))
...
def main():
    ...
    while running:
        ...
        if not game_over and not paused:
            ...
            if any(agent.pos == (cols - 3, rows - 2) for agent in model.schedule.agents):
                game_over = True
